import { FetchedArticle, Article } from '../src/interfaces';
...
export const mockedArticles: Article[] = [
  {
    ...
    published_timestamp: new Date('2019-08-01T15:47:54Z'),
    user: {
      name: 'Vaidehi Joshi',
...
export const mockedFetchedArticle: FetchedArticle = {
  ...
  last_comment_at: new Date('2019-08-06T09:12:45Z'),
  body_html:
